namespace YongBin._10장.MoreOnArray;
...
public class MainApp
{
    ...
    static void Main_(string[] args)
    {
        ...
        Console.WriteLine($"Binary Search : 81 in at " + $"{Array.BinarySearch<int>(scores, 81)}");
        Console.WriteLine($"Linear Search : 90 in at " + $"{Array.IndexOf(scores, 90)}");
